...
import {ILockCallback} from "Oxion-Protocol-v1-core/src/interfaces/ILockCallback.sol";
import {PoolKey} from "Oxion-Protocol-v1-core/src/types/PoolKey.sol";
import {PoolId} from "Oxion-Protocol-v1-core/src/types/PoolId.sol";
...
/// @notice Wraps Oxion Protocol V1 positions in a non-fungible token interface which allows for them to be transferred
/// and authorized.
    ...
    IERC721Permit
{
    ...
    /// @dev details about the Oxion Protocol position
    struct NFTPosition {
