...
import {TokenFixture} from "Oxion-Protocol-v1-core/test/helpers/TokenFixture.sol";
import {IPoolManager, Position} from "Oxion-Protocol-v1-core/src/interfaces/IPoolManager.sol";
...
import {NonfungibleTokenPositionDescriptorOffChain} from
    "../../src/NonfungibleTokenPositionDescriptorOffChain.sol";
...
import {LiquidityManagement} from "../../src/base/LiquidityManagement.sol";
...
contract NonFungiblePositionManagerTest is TokenFixture, Test, GasSnapshot {
    ...
    function setUp() public {
        ...
        string memory baseTokenURI = string.concat("https://.com/v1/", block.chainid.toString(), "/");
        ...
        nonfungiblePoolManager =
            new NonfungiblePositionManager(oxionStorage, poolManager, address(NFTDescriptorProxy), address(0));
    ...
    function testPositions() external {
...

        {
            ...
            uint160 sqrtPriceX96 = uint160(10 * FullMath.Q96);
            // poolManager.initialize(key, sqrtPriceX96);
            nonfungiblePoolManager.initialize(key, sqrtPriceX96);
...

        {
            ...
            assertEq(tickLower, 46020, "Unexpected tickLower");
            assertEq(tickUpper, 46080, "Unexpected tickUpper");
            assertEq(liquidity, 58868861439435980920, "Unexpected liquidity");
            ...
            string memory expectTokenURI =
                string.concat("https://.com/v1/", block.chainid.toString(), "/1");
        ...
        }
        {
            ...
            assertEq(
                feeGrowthInside0LastX128, 5780345646246605728423148919793957641, "Unexpected feeGrowthInside0LastX128"
            );
            assertEq(
                feeGrowthInside1LastX128, 5780345646246605728423148919793957641, "Unexpected feeGrowthInside1LastX128"
            );
            assertEq(tokensOwed0, 0, "Unexpected tokensOwed0");
            assertEq(tokensOwed1, 0, "Unexpected tokensOwed1");
        }
...

        {
            ...
            // ref from Position.update
            // feesOwed0 = FullMath.mulDiv(
            //     feeGrowthInside0X128 - _self.feeGrowthInside0LastX128, _self.liquidity, FullMath.Q128
            // );
            assertEq(
                FullMath.mulDiv(feeGrowthInside0LastX128, liquidity, FullMath.Q128),
                tokensOwed0,
                "Unexpected tokensOwed0"
            );
        }

        assertEq(oxionStorage.balanceOf(address(nonfungiblePoolManager), currency0), 999999999999999999);
        assertEq(oxionStorage.balanceOf(address(nonfungiblePoolManager), currency1), 999999999999999999);
    }
    ...
    function testMint() external {
        ...
        // token consumed
        {
            ...
            assertEq(1000 ether - token0Left, 15292604580728996, "Unexpected currency0 consumed");
            assertEq(amount0, 15292604580728996, "Actual consumed currency0 mismatch");
        ...
        assertEq(liquidity, 117737722878871961840, "Liquidity from mint and liquidity from raw calculation mismatch");
        assertEq(poolManager.getLiquidity(key.toId()), 117737722878871961840, "Unexpected liquidity for the pool");
        assertEq(
            poolManager.getLiquidity(key.toId(), address(nonfungiblePoolManager), 46020, 46080),
            117737722878871961840,
    ...
    function testMint_multiPositionsInSamePriceRange() external {
        ...
        assertEq(token0Before - token0After, 7646302290364498, "Unexpected currency0 consumed");
        assertEq(amount0, 7646302290364498, "Actual consumed currency0 mismatch");
        ...
        assertEq(liquidity, 58868861439435980920, "Liquidity from mint and liquidity from raw calculation mismatch");
        assertEq(poolManager.getLiquidity(key.toId()), 2 * 58868861439435980920, "Unexpected liquidity for the pool");
        assertEq(
            poolManager.getLiquidity(key.toId(), address(nonfungiblePoolManager), 46020, 46080),
            58868861439435980920 * 2,
            "Unexpected liquidity for current position"
        );
    ...
    function testMint_SamePersonMintTokensInSamePriceRange() external {
        ...
        assertEq(_liquidity, 58868861439435980920, "Unexpected liquidity");
        assertEq(feeGrowthInside0LastX128, 0, "Unexpected feeGrowthInside0LastX128");
        assertEq(feeGrowthInside1LastX128, 0, "Unexpected feeGrowthInside1LastX128");
        assertEq(tokensOwed0, 0, "Unexpected tokensOwed0");
        assertEq(tokensOwed1, 0, "Unexpected tokensOwed1");
        ...
        assertEq(_liquidity, 58868861439435980920, "Unexpected liquidity");
        // after donation, the feeGrowthInside0LastX128 and feeGrowthInside1LastX128 should be synced
        assertEq(feeGrowthInside0LastX128, 5780345646246605728423148919793957641, "Unexpected feeGrowthInside0LastX128");
        assertEq(feeGrowthInside1LastX128, 5780345646246605728423148919793957641, "Unexpected feeGrowthInside1LastX128");
        assertEq(tokensOwed0, 0, "Unexpected tokensOwed0");
        assertEq(tokensOwed1, 0, "Unexpected tokensOwed1");
    }
    ...
    function testIncreaseLiquidity() external {
...

        {
            ...
            uint128 liquidityExpected = LiquidityAmounts.getLiquidityForAmounts(
                sqrtPriceX96, TickMath.getSqrtRatioAtTick(46020), TickMath.getSqrtRatioAtTick(46080), 1 ether, 1 ether
            );

            vm.expectEmit(true, true, true, true);
            emit IncreaseLiquidity(1, liquidityExpected, 7646302290364498, 1000000000000000000);
            ...
            assertEq(
                liquidity, 58868861439435980920, "Liquidity from mint and liquidity from raw calculation mismatch"
            );
        }
...

        {
            ...
            assertEq(_liquidity, 58868861439435980920 * 2, "Unexpected liquidity");
            assertEq(feeGrowthInside0LastX128, 0, "Unexpected feeGrowthInside0LastX128");
            assertEq(feeGrowthInside1LastX128, 0, "Unexpected feeGrowthInside1LastX128");
            assertEq(tokensOwed0, 0, "Unexpected tokensOwed0");
            assertEq(tokensOwed1, 0, "Unexpected tokensOwed1");
    ...
    function testDecreaseLiquidity() external {
...

        {
            ...
            vm.expectEmit(true, true, true, true);
            emit DecreaseLiquidity(1, 58868861439435980920, 7646302290364497, 999999999999999999);

            (uint256 amount0, uint256 amount1) = nonfungiblePoolManager.decreaseLiquidity(
                INonfungiblePositionManager.DecreaseLiquidityParams({
                    tokenId: 1,
                    liquidity: 58868861439435980920,
                    amount0Min: 0,
                    amount1Min: 0,
                    deadline: type(uint256).max
                })
            ...
            assertEq(token0After - token0Before, 7646302290364497, "Unexpected currency0 consumed");
            assertEq(amount0, 7646302290364497, "Actual consumed currency0 mismatch");
    ...
    function testBurn_withNonZeroLiquidity() external {
        ...
        nonfungiblePoolManager.decreaseLiquidity(
            INonfungiblePositionManager.DecreaseLiquidityParams({
                tokenId: 1,
                liquidity: 58868861439435980920 - 1,
                amount0Min: 0,
                amount1Min: 0,
                deadline: type(uint256).max
            })
    ...
    function testCollect() external {
        ...
        assertEq(poolManager.getLiquidity(key.toId()), 58868861439435980920, "Unexpected liquidity for the pool");
        assertEq(
            poolManager.getLiquidity(key.toId(), address(nonfungiblePoolManager), 46020, 46080),
            58868861439435980920,
            "Unexpected liquidity for current position"
        );
    ...
    function testFeeGrowthInsideOnverflow_whenAddLiquidityBackToEmptyPosition() external {
...

        {
            ...
            Position.Info memory info =
                poolManager.getPosition(poolKey.toId(), address(nonfungiblePoolManager), 46020, 46080);
            assertEq(info.liquidity, 58868861439435980920, "Unexpected liquidity");
        ...
        // 2. donate to the position so theeGrowthInside0LastX128 and feeGrowthInside1LastX128 are dirty
        ...
        // 4. positionInfo from poolManager with a unzero feeGrowthInside0LastX128 and feeGrowthInside1LastX128
        {
            ...
            assertEq(
                ...
                5780345646246605728423148919793957641,
    ...
    function testFeeGrowthInsideOnverflow_whenFeeGrowthGlobalNaturallyGoOverflow() external {
        ...
        // 3. donate to the position so theeGrowthInside0LastX128 and feeGrowthInside1LastX128 are dirty
        ...
        // 5. swap a bit so that position0(46020, 46080) goes out of range, target tick 46057
        {
            router.swap(
                poolKey,
        ...
        {
            Position.Info memory info =
                poolManager.getPosition(poolKey.toId(), address(nonfungiblePoolManager), 46055, 46058);
            ...
            info = poolManager.getPosition(poolKey.toId(), address(nonfungiblePoolManager), 46055, 46058);

            assertEq(info.liquidity, 1, "Unexpected liquidity");
        }

        (, uint256 feeGrowthGlobal0X128Before, uint256 feeGrowthGlobal1X128Before,) =
            PoolManager(address(poolManager)).pools(poolKey.toId());

        assertEq(
            feeGrowthGlobal0X128Before,
            (type(uint128).max - 1) * FullMath.Q128,
        ...
        // 7. donate 1 ether so that feeGrGlobal goes overflow
        mint(type(uint128).max);
        router.donate(poolKey, 1 ether, 1 ether);
...

        {
            ...
            Position.Info memory info =
                poolManager.getPosition(poolKey.toId(), address(nonfungiblePoolManager), 46080, 46058);
            // positionInfo from nonfungiblePoolManager has been synced
            (
                ,
                ,
    ...
    function testSettleAndMintRefund() external {
        ...
        IERC20(Currency.unwrap(currency0)).transfer(address(oxionStorage), excessTokenAmount);
        ...
        // token consumed
        {
            ...
            assertEq(1000 ether - token0Left - excessTokenAmount, 15292604580728996, "Unexpected currency0 consumed");
            assertEq(amount0, 15292604580728996, "Actual consumed currency0 mismatch");
            // 1e18 i.e. 2 ether, make sense because price is 100
            assertEq(1000 ether - token1Left, 2000000000000000000, "Unexpected currency1 consumed");
            assertEq(amount1, 2000000000000000000, "Actual consumed currency1 mismatch");
